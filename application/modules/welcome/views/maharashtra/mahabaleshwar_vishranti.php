...
<div class="slider-wrapper theme-default">
	<div id="slider" class="nivoSlider"> 
		<img src="<?php echo base_url();?>media/images/subpages/mh-subpages2.JPG" alt="Vinaya Tours - Mahableshwar" />
	</div>
...
<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading margin_b0 animate-box">
					<h2>Mahabaleshwar - 3 Night 4 Days</h2>
				</div>
			</div>
    <div class="row">
    	<div class="col-md-12">
            <div class="panel with-nav-tabs panel-warning package_details_panel">
                ...
                <div class="panel-body">
                    <div class="tab-content">
						...
						Arrive 6.00 Am At Mahabaleshwar. Whole day for Leisure By Own, <br/>
						</li><br/>
						<li>
						<strong>Day 3</strong>
						Proceed For Pratapghad Darshan (TourTime 3 ½ Hours): Pratapghad Fort, Accent Caves, Watch Tower, Drum Hall, Underground Tunnel, Bhavani Mandir, Shivaji Statue, Pratapghad Garden, Punishment Point, Kabar Of Afzalkhan. <br/>
						(Meal: Lunch & Dinner).
						</li><br/>
						<li><strong>Day 4: Mahabaleshwar Darshan & Panchagani</strong>
						...
						<li><strong>Day 5: Check Out time 8.00 AM </strong>
						...
						<li>Accommodation in deluxe AC Room.</li>
						<li>Meal - 3 B/f, 3 Lunch & 3 dinner.</li>
