...
<div class="slider-wrapper theme-default">
	<div id="slider" class="nivoSlider"> 
		<img src="<?php echo base_url();?>media/images/subpages/Rajasthan 1024x300 1.jpg" alt="Vinaya Tours - Rajashthan"/> 
	</div>
...
<div class="row">
    ...
    <div id="products" class="row list-group col-md-12 col-xs-12 col-lg-12 col-sm-12">
        <div class="item  col-xs-12 col-lg-4 col-md-4 col-sm-12">
            <div class="thumbnail">
                <img class="group list-group-image" src="<?php echo base_url();?>media/images/subpages/Rjasthan 358x358 1.jpg" alt="" />
                <div class="caption">
                    <h4 class="group inner list-group-item-heading">
                        Mount Abu</h4>
                    <p class="group inner list-group-item-text">
                        Ambaji - Nakki Lake - Addhardevi - Delwara Temple - Guru Shikher</p>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <a class="btn btn-success" href="<?php echo site_url('mount-abu'); ?>">Details</a>
                        </div>
                    </div>
                </div>
            </div>
