...
<html>
	...
	*/?>
	...
	<!-- Theme style  -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>media/css/style.css?20180904">
	...
	{
		$contact_active = 'home_page_active_class';
	}
	else{
		$contact_active = '';
	}
	...
	{
		$about_active = 'home_page_active_class';
	}
	else{
		$about_active = '';
	}
	if($page_name == '')
	{
		$home_active = 'home_page_active_class';
	}
	else{
		$home_active = '';
	}
	...
	{
		$package_active = 'home_page_active_class';
	}
	else{
		$package_active = '';
	}
	...
	{
		$testimonial_active = 'home_page_active_class';
	}
	else{
		$testimonial_active = '';
	}
	...
	{
		$gallery_active = 'home_page_active_class';
	}
	else{
		$gallery_active = '';
	}
	...
	{
		$group_tour_active = 'home_page_active_class';
	}
	else{
		$group_tour_active = '';
	}
			...
			<div class="container">
				...
				<div class="col-xs-2">
					...
					<div class="col-xs-12 text-right">
						<p class="num" style=""><a href="<?php echo site_url('contact-us');?>" title="Contact Us">Call: +91 84240 57936</a></p>
	...
	<div class="collapse navbar-collapse js-navbar-collapse">
		...
		<li class="dropdown mega-dropdown">
				<a href="<?php echo site_url('');?>" class="<?php echo $home_active?>">Home</a>		</li>
			<li class="dropdown mega-dropdown">
				<a href="#" class="dropdown-toggle <?php echo $package_active?>" data-toggle="dropdown">Packages <span class="caret"></span></a>				
				<ul class="dropdown-menu mega-dropdown-menu">
					...
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header">Kerala Houseboat Packages</li>
					...
					<li class="col-sm-3">
						<ul>
							...
							<li><a href="<?php echo site_url('manali-volvo');?>">Manali Volvo Couple Package</a></li>
							<li><a href="<?php echo site_url('manali-car');?>">Manali Car Package</a></li>
							<li><a href="<?php echo site_url('simla-manali-car');?>">Simla Manali Car Package</a></li>                            
							<li><a href="<?php echo site_url('simla-manali-volvo');?>">Simla Manali Volvo Package</a></li>							
							<li><a href="<?php echo site_url('simla-manali-agra');?>">Agra Manali Car Package</a></li>							
							<li><a href="<?php echo site_url('chandigarh-manali');?>">Chandigarh Manali Car Package</a></li>							
							<li><a href="<?php echo site_url('dalhousie-manali-tours');?>">Simla Manali Dalhousie Package</a></li>							
						</ul>
					</li>
					<li class="col-sm-3">
						<ul>
        ...
        <li class="<?php echo $gallery_active; ?>"><a href="<?php echo site_url('gallery');?>" title="Gallery">Gallery</a></li>
							<li class="<?php echo $testimonial_active; ?>"><a href="<?php echo site_url('testimonial');?>" title="Testimonials">Testimonials</a></li>
							<li class="<?php echo $about_active; ?>"><a href="<?php echo site_url('about-us');?>" title="About Us">About Us</a></li>
							<li class="<?php echo $contact_active; ?>"><a href="<?php echo site_url('contact-us');?>" title="Contact us here">Contact</a></li>
		</ul>
	</div><!-- /.nav-collapse -->
  </nav>
