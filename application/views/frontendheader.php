...
<html>
	...
	*/?>
	...
	<!-- Theme style  -->
	<link rel="stylesheet" href="<?php echo base_url(); ?>media/css/style.css?20180527">
		...
		<li class="dropdown mega-dropdown <?php echo $li_page_active_class;?>">
			...
			<li class="dropdown mega-dropdown">
				...
				<ul class="dropdown-menu mega-dropdown-menu">
					...
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header"><a href="<?php echo site_url('kerala-houseboat');?>">Kerala Houseboat</a></li>
							...
							<li class="divider"></li>
							<li class="dropdown-header"><a href="<?php echo site_url('goa');?>">Goa</a></li>
					...
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header"><a href="<?php echo site_url('maharashtra');?>">Maharashtra</a></li>
							...
							<li class="divider"></li>
							<li class="dropdown-header"><a href="<?php echo site_url('rajashthan');?>">Rajasthan</a></li>
